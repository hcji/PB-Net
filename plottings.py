...
plt.clf()
plt.plot(x*0.6, y_bl, '.-', color=color_bl, label='baseline')
plt.plot(x*0.6, y_seq, '.--', color=color_seq, label='Seq PB-Net')
plt.plot(x*0.6, y_seq_aug, '.-', color=color_seq, label='Seq PB-Net(augmented)')
plt.plot(x*0.6, y_ref, '.--', color=color_ref, label='Ref PB-Net')
plt.plot(x*0.6, y_ref_aug, '.-', color=color_ref, label='Ref PB-Net(augmented)')
